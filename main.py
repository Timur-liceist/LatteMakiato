...
from release.untitled import Ui_MainWindow
from release.addEditCoffeeForm import AddingWindow



class RedactWindow(QMainWindow, AddingWindow):
...
class AddingWindow(QMainWindow, AddingWindow):
